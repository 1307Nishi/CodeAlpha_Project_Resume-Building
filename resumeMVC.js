...
function createHeadingSection(resumeViewRef) {
  ...
  leftDivImg.src =
    "/home/student/Desktop/Resume-Builder-MVC-master/clg.jpeg";
...
const headingSectionFormConfig = [
  ...
  },
  {
    ...
    content: ["your mail@rguktrkv.ac.in"],
  },
  {
    id: `headingSectionForm${4}`,
    content: ["Date of Birth(September 29, 2000)"],
  },
  {
...
const educationSectionFormConfig = [
  ...
  },
  {
    ...
    content: [
      "Secondary | Class X",
      "Zilla Parishad High School,Yadamari,Chittoor",
      "2016",
      "95%",
    ],
  },
...
const skillsSectionFormConfig = [
  ...
  },
  {
    ...
    content: ["Programming Language(s)", "C, C++, PostgreSQL,Python"],
  },
  {
...
const internshipSectionFormConfig = [
  {
    ...
    content: [
      "Exposys Data Labs, Banglore",
      "(Remote Internship)",
      "Used to Develop a full stack development Burger Website and .",
